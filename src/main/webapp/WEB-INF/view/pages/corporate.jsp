...
<head>
    ...
    <meta name="description"
          content="корпоративный праздник">
    <meta name="keywords"
          content="корпоратив под ключ, интересный корпоратив, день рождения компании, новый год в офисе, квест в офис">
    <meta charset="utf-8"/>
...
<!---- Two ---->
<div class="container">
    <h1 class="text-center">Корпоратив с живым квестом!</h1>
    <h4 class="text-center">Праздник под ключ!</h4>
    <h2 class="text-center" style="padding-top: 10px; padding-bottom: 10px;">Квесты, идеально подходящие для корпоратива</h2>
    <div class="card-deck">
        <div class="card text-center" style="width: 18rem;">
            <img class="card-img-top" src="resources\images\corporate\1.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Этот безумный мир</h5>
                <p class="card-text text-justify">
                В этом квесте вам и вашим коллегам предстоит стать безумными волшениками, которым нужно срочно спасти мир.
                    В вашей Магической библиотеке произошел взрыв,
                    в результате которого из Книги Великих Магических Заклинаний вырвалось одно заклинание... Оно немного
                    изменило реальность, и теперь к Плоскому миру летит огромный красный метеорит! А еще, стали открываться
                    порталы, из которых выходят разгневанные боги. А все волшебники сошли с ума и не помнят ни одного заклинания.
                    Что же делать? Что делать?!
                <div class="text-dark">
                Жанр: комедия, пародия<br>
                Участников: от 6 до 25<br>
                    Длительность: 2 часа<br>
                    Стоимость: от 5 300 руб
                </div>
                </p>
        ...
        <div class="card text-center" style="width: 18rem;">
            <img class="card-img-top" src="resources\images\corporate\2.JPG" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">По Законами мафии Нью-Йорка</h5>
                <p class="card-text text-justify">
                    В этом квесте вам предстоит стать самыми настоящими мафиози! Крестный отец мафии Нью-Йорка позвал все
                    банды Нью-Йорка на вечеринку в честь окончания года. Он собирался поощрить тех, кто хорошо послужил семье,
                    и наказать тех, кто плохо старался. Но кто-то подставил Крестного, и его задержала полиция. У вашей банды
                    появилось немного времени, чтобы стать лучшей, наказать всех ваших конкурентов и, может быть, даже украсть общак?
                    <br><br>
                <div class="text-dark">
                Жанр: вечеринка<br>
                Участников: от 20 до 50<br>
                    Длительность: 3 часа<br>
                    Стоимость: от 22 900 руб
                </div>
                </p>
                <a href="gangstaParty" class="btn btn-primary">Подробнее</a>
                <a href="registration" class="btn btn-success">Захватить Нью-Йорк</a>
            </div>
        </div>
        <div class="card text-center" style="width: 18rem;">
            <img class="card-img-top" src="resources\images\corporate\3.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Шервудский лес</h5>
                <p class="card-text text-justify">
                Вы давно думали о том, чтобы отправиться в Средневековую Англию, поохотиться на оборотней,
                сжечь парочку ведьм, вспахать поле и спасти Англию от королевского гнета? Тогда этот квест - это то, что
                вы ищите! Кто будет на стороне короля, а кто - на стороне простых жителей, и кто же победит в этом сражении?
                <div class="text-dark">
                    Участников: от 10 до 30<br>
                    Длительность: 2 часа<br>
                    Стоимость: от 9 800 руб
                </div>
                </p>
                <a href="sherWood" class="btn btn-primary btn-responsive">Подробнее</a>
        ...
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Мы распределяем роли среди участников квеста и раздаем всем книжечки с описанием персонажей.
                    Вы знакомитесь с персонажами и друг с другом, узнаете, как вы тут оказались и чего же ктьо хочет. Да, придется
                немного почитать ;)</p>
            </div>
        </div>
        <i class="fa fa-arrow-right" style="font-size:48px; padding-top: 150px; padding-right: 50px;"></i>
        <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="resources\images\corporate\4.JPG" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title text-center">Выполняем цели!</h5>
                <p class="card-text">У вас будет одна общая цель, спасти мир, например. И будут личные задания -
                    заработать денег, найти суженого, сбагрить награбленное, или вручить кому-то проклятый амулетик.
                Как же выполнять цели? Только общаясь с другими игроками! Тут пригодятся ваши лидерские качества, харизма и
                сила убеждения. Развитие сюжета зависит только от вас</p>
            </div>
        </div>
    </div>
</div>
...
<div class="container">
    ...
    <h3 class="text-center">Мы можем привезти наш квест к вам в офис, в любое кафе и даже на природу!</h3>
    <div class="card-deck">
        <div class="card text-center" style="width: 18rem;">
...
<div class="container">
    ...
    <div class="card-deck">
        ...
        <div class="card text-center" style="width: 18rem;">
            <img class="card-img-top" src="resources\images\corporate\5.jpg" alt="Card image cap">
            <div class="card-body">
