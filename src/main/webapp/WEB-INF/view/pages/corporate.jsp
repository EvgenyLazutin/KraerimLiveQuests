...
<script>
  ...
  gtag('config', 'UA-119774437-1');
    ...
    <meta name= "description" content = "квест на корпоратив">
    <meta name= "keywords" content = "выездные квесты, квест на корпоратив, для большой компании, где отметить корпоратив, организация корпоратива">
    <meta charset="utf-8" />
...
<section id="two" class="wrapper style2">
    <div class="inner">
        <div class="box">
            <div class="content">
                <header class="align-center">
                    <h2><strong>Живой квест на корпоратив!</strong></h2>
                </header>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm">
                            <img class="image main" src="/resources/images/corporate/1.jpg" alt=""/>
                        </div>
                        <div class="col-sm">
                            <h3>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <img class="image main" src="/resources/images/corporate/2.jpg" alt="" />
                        </div>
                    </div>
                </div>
                <div class="container-fluid">
                    <div class="row">
                            <div class="col-sm">
                                <img class="image main" src="/resources/images/corporate/3.jpg" alt=""/>
                            </div>
                            <div class="col-sm">
                                <h3>
                                    <div class="text-justify"> <strong>Почему именно наш живой квест?</strong><br><ul>
