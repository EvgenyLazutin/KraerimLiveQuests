...
<script>
  ...
  gtag('config', 'UA-119774437-1');
    ...
    <title>Murder in a monastery</title>
    <meta name= "description" content = "детективный квест на день рождения">
    <meta name= "keywords" content = "детективное расследование, настоящий детектив, квест детектив, сложный квест">
    <meta charset="utf-8" />
        ...
        <div class="box">
            <div class="content">
                <header class="align-center">
                    ...
                    <h2>Живой квест "Убийство в монастыре"</h2>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <h3>
                                <div class="text-justify">15 век, где-то в горах Испании, монастырь Святой девы Марии.<br>
                                ...
                                В воскресенье в монастыре должен был состояться теологический диспут по поводу бедности
                                    Христа. Это очень важное событие, на него собираются известнейшие теологи-монахи.
                                    Среди них - и инквизитор от папского престола, который считает это мнение совершеннейшей ересью.</div>
                            </h3>
                        </div>
                    </div>
                </div>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm">
                            <h3>
                                <div class="text-justify">Однако в субботу, после утренней молитвы, выяснилось, что брат Титус, один из участников диспута и самый известный оратор,
                                ярый сторонник идеи о том, что Христос был беден, был убит! Так совпало, что он же был и главным хранителем библиотеки...<br>
                                    Тело Титуса было обнаружено в келье. Причина смерти – неизвестна, но похоже на удушение.</div></h3>
                            </h3>
                        </div>
                        <div class="col-sm">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <h3>
                                ...
                                - за компанию 6 - 10 человек: 4 900 р.<br>
