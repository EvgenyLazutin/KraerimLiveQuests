            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <h3>
                                Недалекое будущее, миром правят гигантские корпорации.В области космического строения на первый план вышли три компании:
                                ...
                                сигнал поступал с перерывами, а затем связь и вовсе оборвалась.
                            </h3>
                        </div>
                    </div>
                </div>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm">
                            <h3>
                                И совсем некстати, на базе SpaceX не осталось профессиональных космонавтов... Поэтому, отправили вас, пообещав более чем щедрое вознаграждение.
                                ...
                                внешних повреждений на корабле не было.
                            </h3>
                        </div>
                        <div class="col-sm">
