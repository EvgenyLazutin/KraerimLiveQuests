...
<div class="bg_mobile">
    <div class="text-center text-white">
        <h1>Неправильный ответ.<br>
            <img class="img-thumbnail" src="../../../resources/images/quest/wrongAnswer.jpg" alt="" />
            Попробуйте еще раз!
        </h1><br>
        <a href="#" onclick="window.history.back(-1);return false;">Назад</a>
    </div>
    <!-- Footer -->
    <footer id="footer">
