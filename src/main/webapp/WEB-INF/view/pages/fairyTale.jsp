...
<!-- One -->
<section id="one" class="wrapper styleFairyTale">
    <div class="inner">
    ...
    <div class="inner">
        <div class="box">
            <div class="content">
                ...
                <h3> <span class="image right"><img src="/resources/images/fairyTale/1.jpg" alt="" /></span>Несколько дней назад вам пришло письмо от Петра Вениаминовича Кощейкина, среди сказок больше известного как Кощей Бессмертный. В письме он настоятельно рекомендовал вам прибыть в отель «Теремок», что в Темном лесу, в самое ближайшее время. Дорогу к отелю могут найти только Сказочные существа. В «Теремке» находится один из источников Сказки, откуда она распространяется по миру, привнося Здравый смысл в жизнь Сказок и, одновременно, наполняя Волшебством мир людей.<br></h3>

                <h3> <span class="image left"><img src="/resources/images/fairyTale/2.jpg" alt="" /></span>Это было предложение, от которого невозможно было отказаться – вы тут же тронулись в путь. Когда вы явились в отель, там было полно других сказочных существ, но самого Кощея не было. Куда же он делся? И почему ваши сказочные силы начали истощаться?<br></h3>
                ...
                <ul class="alt">
                    ...
                    <li> <h3>вы давно хотели превратить кого-нибудь в мышь, а карету - в тыкву<br></h3></li> </ul>
...
<!-- Three -->
<section id="three" class="wrapper styleFairyTale">
    <div class="inner">
        <header class="align-center">
            <p>Узнай, что за краем мира</p>
            <h2>Краерим. Живые квесты</h2>
