    ...
    <div class="inner">
        <div class="box">
            <div class="content">
                ...
                <ul class="alt">
                    <li> <h3>вы любите интриговать и манипулировать людьми<br></h3></li>
                    <li> <h3>вы давно хотели стать Императором какого-нибудь государства<br></h3></li>
                    <li> <h3>вы давно мечтали бросить кому-нибудь перчатку в лицо, чтобы вызвать на дуэль<br><br></h3></li> </ul>

                <h3> <span class="image left"><img src="/resources/images/masquerade/4.jpg" alt="" /></span>
                    <br>
