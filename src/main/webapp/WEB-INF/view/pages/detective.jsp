                        ...
                        <div class="col-sm">
                            <h3>
                                ...
                                <a class="text-justify"> <ul>
                                    ...
                                    <li> Исход игры всегда зависит только от игроков, их убедительности и доверчивости</li></ul>
                                </a>
                            </h3>
                        </div>
                        <div class="col-sm">
                        ...
                        <div class="col-sm">
                            <h3>
                                ...
                                <a class="text-justify"> <ul>
                                    ...
                                    <li> Вы узнаете ваших друзей с новой стороны и сможете объединить людей из разных тусовок!</li></ul>
                                </a>
                            </h3>
                        </div>
                    </div>
