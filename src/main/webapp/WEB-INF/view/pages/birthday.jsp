                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    Кто же станет новым правителем? Может быть, вы?<br>
                                        Количество участников: от 8 до 32<br>
                                        Стоимость: 8 500 руб.<br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <h3>
                                ...
                                найти убийцу или даже спасти мир. Но у каждого персонажа игры есть собственная история и личные цели, которых он может достичь через переговоры, убеждение,
                            ...
                            <div class="col-sm" style="padding-right: 30px;">
                                <h3>
                                    ...
                                    <a class="text-justify"> <ul>
                                        ...
                                        <li> У вас собирается очень разношерстная компания, в которой многие люди не знакомы. Наш квест поможет сдружить даже совершенно незнакомых людей!</li>
