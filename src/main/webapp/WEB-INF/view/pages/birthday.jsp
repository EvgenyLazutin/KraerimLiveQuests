                            ...
                            <div class="col-sm">
                                <h3>
                                    ...
                                    <div class="text-justify"> <ul>
                                        ...
                                        <li> Если вы заказываете квест у нас, то получаете фотографа в подарок!</li>
                                        <li> 10% скидка всем именинникам, лично заказавшим живой квест</li></ul></div>
                                </h3>
                            </div>
                    </div>
                </div>
                        ...
                        <div class="col-sm">
                           <h3>
                            ...
                            — <a href="zombiequest">«Зомби-апокалипсис»</a><br>
                               <strong> На среднюю компанию (15-30 человек):</strong><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <h3>
                                ...
                                <div class="text-justify">Минимальная стоимость игры - 4 900 рублей. <br>
                                <strong>Что входит в стоимость игры?</strong><br>
                                - помощь в подборе места для проведения игры<br>
                                - ведущий (или несколько, в зависимости от количества участников)<br>
                                - музыкальное сопровождение<br>
                                - базовый реквизит (шляпы, веерочки, сабли)<br>
                                    - фотограф (25-30 фотографий)<br></div>
                            </h3>
                        </div>
                    </div>
                </div>
