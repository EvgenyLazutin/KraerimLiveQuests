    ...
    <div class="inner">
            <div class="content">
                ...
                <div class="container-fluid">
                    <div class="mycard">
                        <div class="card-header text-center"><h1><strong>Живые квесты, идеально подходящие для Дня рождения подростка </strong></h1>
                            <br>
                            <div class="card-group">
                                <div class="card">
                                    <img class="card-img-top" src="resources\images\teens\5.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title">Квест-стрелялка "Brawl Stars"</h4>
                                        <p class="card-text"><strong>Для ребят, которые фанатеют от Brawl Stars</strong><br>
                                            <div class="text-justify">Ребятам предстоит научиться стрелять по мишеням, их ждут головоломки и несколько уровней сложности игры.
                                        Будет дартс с бомбами и динамитом. А также битва с боссом!<br>
                                            Участников: от 1<br>
                                        ...
                                        <footer class="align-center">
                                            <a href="BrawlStars" class="btn btn-lg btn-outline-primary">Узнать подробнее</a>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title">Детективный квест "Among Us"</h4>
                                          <div class="text-justify">Детективно-активный квест для ребят в возрасте от 5 до 15 лет!
                                              Если вы не знаете, что это за игра такая, то спросите у вашего ребенка, он(а) точно знает: это хит!
                                            <br>
                                            Количество участников: от 2<br>
                                            Стоимость: 6 500 руб.<br>
                                            Длительность: 1,5 часа
                        ...
                        <div class="col-sm">
                            <h3>
                                ...
                                <a class="text-justify"> <ul>
                                    ...
                                    <li>На месте: ведущий рассказывает ребятам предысторию</li>
                                    <li> Ребята знакомятся друг с другом, и… Начинают выяснять правду, сражаться друг с другом и с монстарми, и спасать мир!</li>
                                    <li> Исход игры всегда зависит только от игроков, их фантазии и доверчивости</li></ul>
                                </a>
                            </h3>
                        </div>
                        <div class="col-sm">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <h3>
                                ...
                                <a class="text-justify"> <ul>
                                    ...
                                    <li> После нашего квеста остаются самые лучшие фотографии, которые обязательно нужно выложить в Instagram!</li></ul>
                                </a>
                            </h3>
                        </div>
                    </div>
                        ...
                        <div class="container-fluid container-center">
                            <div class="row">
                                <div class="col-sm">
                                    <div class="card-header text-center"><strong><h1>Стоимость:</h1>
                                        </strong>
                        ...
                        <div class="container-fluid">
                            <div class="mycard">
                                <div class="card-header text-center"><h1><strong>Отзывы об играх:
                                </strong></h1>
                                    <br>
                        ...
                        <br>
                        <div class="card-header text-center"><h2><strong>Где провести праздник?
                            </strong></h2>
