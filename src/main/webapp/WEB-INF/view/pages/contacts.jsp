                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                           <h3> <span class="align-left d-none d-sm-block"><strong>Наш телефон:</strong> +79516696094<br></span>
                            ...
                            космонавтом и даже Драконом. Вам не надо будет выбираться из комнаты, только выполнять свои цели, общаясь с другими игроками.
                           </h3>
                        </div>
                        <h3>
                            <strong>Как это работает?</strong><br>
                           1. Вы выбираете одну из наших игр, дату и место проведения игры (мы всегда готовы помочь вам с выбором). <br>
                            2. Мы с вами распределяем персонажей (либо это можно сделать на месте)
                            3. На месте, мастер игры рассказывает вам предысторию: как вы здесь оказались, а вы знакомитесь с личной историей вашего персонажа: кто вы, что вы здесь делаете, кого вы любите и ненавидите.
                            В "листе персонажа" указано несколько целей, которые вам нужно будет выполнить по ходу игры. Цели персонажа - это самое главное, постарайтесь выполнить их любой ценой! <br>
                            4. Вы знакомитесь со всеми присутствующими, и… Начинаете плести интриги и запутывать остальных, или, наоборот, выяснять правду.
                            Например, вы - глава одной из самых благородных семей в Империи. И ваша цель - занять престол. У вас есть деньги, а вот у другой благородной семьи денег почти нет... ПОчему бы этим не воспользоваться? <br>
                            <br>
