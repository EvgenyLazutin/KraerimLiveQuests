...
<script>
  ...
  gtag('config', 'UA-119774437-1');
    ...
    <meta name= "description" content = "как с нами связаться">
    <meta name= "keywords" content = "живые квесты, где отметить день рождения, как отметить день рождения">
    <meta charset="utf-8" />
                        ...
                        <div class="col-sm">
                           <h3> <span class="align-left d-none d-sm-block">Мы находимся в Санкт-Петербурге, но с удовольствием рассмотрим варианты сотрудничества с другими городами!<br>
                            ...
                            <strong>Мы в Вконтакте:</strong> <a href="https://vk.com/kraerim">  vk.com/kraerim</a><br><br>
                               <div class="text-justify"> <strong>Что такое «живой квест»?</strong><br>
                           Бывало ли у вас так? Смотрите фильм (причем, даже не важно — какой, ужастики, драму или комедию) и думаете: «Нет, ну что он творит,
                            ...
                            становитесь другим человеком (или даже не человеком вовсе), и творите новую историю. Вы можете стать детективом, магом, рыцарем,
                                   космонавтом и даже Драконом. Вам не надо будет выбираться из комнаты, только выполнять свои цели, общаясь с другими игроками.</div>
                           </h3>
                        </div>
                        <h3>
                            <strong>Как это работает?</strong><br>
                            <div class="text-justify"> <ol>
                                <li>Вы выбираете один из наших квестов, дату и место проведения игры (мы всегда готовы помочь вам с выбором). </li>
                                <li>Мы с вами распределяем персонажей среди участников квеста(это можно сделать как заранее, так и на месте)</li>
                            <li> На месте, мастер игры рассказывает вам предысторию: как вы здесь оказались и что происчходит. Затем, он раздает участникам книжечки с описанием персонажей. Вы знакомитесь с историей вашего персонажа: кто вы, что вы здесь делаете, кого вы любите и ненавидите.
                                И узнаете какие цели преследует ваш персонаж. Цели персонажа - это самое главное, постарайтесь выполнить их любой ценой! </li>
                            <li>Вы знакомитесь со всеми присутствующими, и… Начинаете плести интриги и запутывать остальных, или, наоборот, выяснять правду.
                                Например, вы - глава одной из самых благородных семей в Империи. И ваша цель - занять престол. У вас есть деньги, а вот у другой благородной семьи денег почти нет... Почему бы этим не воспользоваться? </li></ol>
                            <br>
                            - Исход игры всегда зависит только от игроков и их фантазии (или того, как внимательно они прочитали свою собственную историю). <br>
                            - На наших играх можно запросто найти новых друзей и даже вторую половинку❤️ <br><br>
                            ...
                            чтобы у вас на память остались самые лучшие и веселые фотографии.
                                    А вас попросим только написать отзыв)<br><br></a>
                            </div>
                            We have the menu in english! </a>
                        </h3>
                       </div>
                    <div>
