...
<div class="bg_mobile">
    <div class="text-center text-white">
                            <h1>Вопрос 11. Шифр Цезаря<br>
                                <img class="img-thumbnail" src="../../../resources/images/quest/question11.jpg" alt="Responsive image" />
                                -2<br>
                                ИХТПВНКУФ
                                <br><br>
                                Что за слово зашифровано?
                            </h1><br>

                                    <div>
                                            <%request.setCharacterEncoding("ISO-8859-1");%>
                                            <form:form method="POST" action="/quest/14c4b3dc-1bd8-11ec-9621-0242ac130002/checkAnswer"
